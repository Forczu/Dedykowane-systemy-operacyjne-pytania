...
\begin{enumerate}
	...
	\item \question{Efekt polecenia ls -l file.txt jest następujący: \\
		...
		W następnym kroku powyższemu plikowi nadano pewne uprawnienia SCL, a następnie wykonano polecenie getfacl file.txt uzyskując następujący wynik: \\ \\
		$\sharp$file: file.txt \\
		$\sharp$owner: me \\
	...
	\item \question{Efekt polecenia ls -l test jest następujący: \\
		...
		W następnym kroku powyższemu plikowi nadano pewne uprawnienia SCL, a następnie wykonano polecenie getfacl test uzyskując następujący wynik: \\ \\
		$\sharp$file: test \\
		$\sharp$owner: so1 \\
		$\sharp$group: students \\
		user::rwx \\
	...
	\item \question{Zaznacz poprawne odpowiedzi dotyczace maski oraz wyznaczania uprawnień dla wpisów ACL powiązancyh z klasą grupy:}
	...
	\item \question{Efekt polecenia ls -l test.txt jest następujący: \\
		...
		W następnym kroku powyższemu plikowi nadano pewne uprawnienia SCL, a następnie wykonano polecenie getfacl test.txt uzyskując następujący wynik: \\ \\
		$\sharp$file: test \\
		$\sharp$owner: so1 \\
		$\sharp$group: students \\
		user::rwx \\
